...
exports.withWidgetIos =
  exports.DEFAULT_TOP_LEVEL_FILES =
  exports.DEFAULT_WIDGET_TARGET_NAME =
    void 0;
...
const withWidgetIos = (config, { widgetName, ios }) => {
  ...
  config = (0, withWidgetEntitlements_1.withWidgetEntitlements)(config, {
    targetName,
    appGroupIdentifier,
  });
  config = (0, withWidgetSourceFiles_1.withWidgetSourceFiles)(config, {
    targetName,
    appGroupIdentifier,
  });
